      ...
      >
        ...
        <div className="px-4">
          ...
          <div className="flex flex-row gap-4">
            <button
              className="bg-yellow-50 rounded-md text-black p-2 w-fit"
              onClick={
            ...
            {(!user || !course?.studentEnrolled.includes(user?._id)) && (
              <button onClick={handleAddToCart} className="bg-richblack-900 text-richblack-5 rounded-md p-2 ml-4 w-fit">
                Add to Cart
              </button>
            )}
          </div>
