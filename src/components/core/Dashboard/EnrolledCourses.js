...
export default function EnrolledCourses() {
  ...
  return (
    <>
      <div className="text-sm sm:text-3xl text-richblack-50">Enrolled Courses</div>
      {!enrolledCourses ? (
        ...
        <div className="my-4 sm:my-8 text-richblack-5">
          <div className="flex flex-col sm:flex-row rounded-t-lg bg-richblack-500 sm:text-xl text-xs">
            <p className="w-full sm:w-[45%] px-1 py-1 sm:px-5 sm:py-3">Course Name</p>
            ...
            >
              ...
              >
                ...
                <div className="flex max-w-xs flex-col gap-1 sm:gap-2">
                  <p className="text-xs sm:text-base sm:font-semibold font-medium">{course.courseName}</p>
