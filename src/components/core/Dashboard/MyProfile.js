...
export default function MyProfile() {
  ...
  return (
    <>
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 lg:px-12">
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row max-w-[500px] justify-between gap-y-5 lg:gap-y-0">
